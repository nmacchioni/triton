...
def do_bench(_callable, lazily=False, ranking_key=None, pruning_key=None, **kwargs):
    ...
    if lazily:
        return benchmarker.lazy_benchmark_gpu(_callable, ranking_key=ranking_key, pruning_key=pruning_key)
    else:
        return benchmarker.benchmark_gpu(callable)
